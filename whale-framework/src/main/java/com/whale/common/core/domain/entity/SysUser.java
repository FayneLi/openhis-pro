package com.whale.common.core.domain.entity;
...
import com.whale.common.xss.Xss;
...
public class SysUser extends BaseEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("userId", getUserId())
                ...
                .append("deleteFlag", getDeleteFlag()).append("loginIp", getLoginIp()).append("loginDate", getLoginDate())
