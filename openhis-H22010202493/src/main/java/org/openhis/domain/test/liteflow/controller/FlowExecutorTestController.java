package org.openhis.domain.test.liteflow.controller;
...
public class FlowExecutorTestController {
    ...
    public String index(ModelMap modelMap){
        try {
            ...
            context.setClassName("org.openhis.domain.test.liteflow.entity.ClassEntity");
            context.setPackageName("org.openhis.domain.test");
